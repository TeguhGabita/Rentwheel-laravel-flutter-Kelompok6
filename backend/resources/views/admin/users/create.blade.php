<x-admin-layout>
    ...
    <x-slot name="subtitle">Buat akun baru</x-slot>
    ...
    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-8 max-w-2xl">
        <form method="POST" action="{{ route('admin.users.store') }}" class="space-y-5">
            ...
            <div class="flex justify-end gap-3 pt-4">
                ...
                <button type="submit" class="px-5 py-2.5 rounded-lg bg-amber-400 text-slate-900 text-sm font-semibold hover:bg-amber-300">Simpan</button>
            </div>
        </form>
    </div>
</x-admin-layout>