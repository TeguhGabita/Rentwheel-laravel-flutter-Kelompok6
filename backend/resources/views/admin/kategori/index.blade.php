    ...
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-6">
        <form method="GET" class="w-full flex flex-col sm:flex-row gap-3">
            ...
            <select name="urutan" onchange="this.form.submit()"
                    class="w-full sm:w-52 px-3 py-2.5 text-sm rounded-xl border border-slate-200 focus:border-amber-400 focus:ring-amber-400 focus:outline-none focus:ring-1">
                ...
                <option value="mobil_terbanyak" {{ request('urutan') == 'mobil_terbanyak' ? 'selected' : '' }}>Jumlah Mobil Terbanyak</option>
            </select>
