<x-app-layout>
    <x-slot name="header">
        <h2 class="font-semibold text-xl text-neutral-800 leading-tight">Tambah Mobil</h2>
    </x-slot>
            ...
            <form method="POST" action="{{ route('mobil.store') }}">
                ...
                <div class="bg-white p-6 rounded-2xl border space-y-4">
                    <div>
                        ...
                        <input name="nama_mobil" class="mt-1 block w-full border rounded p-2" required>
                    </div>
                    ...
                    <div>
                        ...
                        <input name="merk" class="mt-1 block w-full border rounded p-2">
                    </div>

                    <div>
                        <label class="block text-sm">Plat Nomor</label>
                        <input name="plat_nomor" class="mt-1 block w-full border rounded p-2" required>
                    </div>

                    <div>
                        <label class="block text-sm">Harga sewa per hari</label>
                        <input name="harga_sewa_per_hari" type="number" step="0.01" class="mt-1 block w-full border rounded p-2" required>
                    </div>
